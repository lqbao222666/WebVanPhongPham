var itemList = {
  paper01: {
    name: "Giấy in A4 Double A 70gsm - Thái Lan Chính Hãng (500 tờ)",
    price: 79000,
    photo: "images/sanpham/paper/giay-a4-double.jpg",
  },
  paper02: {
    name: "Giấy in A4 Supreme ĐL70",
    price: 65000,
    photo: "images/sanpham/paper/Giay-in-A4-Supreme-DL70.webp",
  },
  paper03: {
    name: "Giấy A4 IK Plus 70 gsm",
    price: 70000,
    photo: "images/sanpham/paper/giay-a4-ik-plus-70-gsm-6703.jpg",
  },
  notebook01: {
    name: "NOTEBOOK - Tập Vở, Sổ Kẻ Ngang size A5",
    price: 15000,
    photo: "images/sanpham/notebook/tap-a5.jfif",
  },
  notebook02: {
    name: "Tập Notebook A4 (200 trang)",
    price: 10000,
    photo: "images/sanpham/notebook/noteA4-200tr.jpg",
  },
  notebook03: {
    name: "Tập sinh viên Campus Basic Notebook 120 trang 70gsm kẻ ngang dán gáy",
    price: 19000,
    photo: "images/sanpham/notebook/tap-campus.webp",
  },
  pen01: {
    name: "Hộp 20 Bút Bi 0.5 mm Treeden - Thiên Long TL-079 - Mực Xanh",
    price: 64000,
    photo: "images/sanpham/pen/thienlongTL-pen.webp",
  },
  pen02: {
    name: "Bút gel mực xanh/OT-GP004BU",
    price: 6000,
    photo: "images/sanpham/pen/OT004BU.webp",
  },
  pen03: {
    name: "Bút Mực Nước Mực Đen/Đỏ/Xanh 0.5mm 3 Màu Tùy Chọn",
    price: 5000,
...
function showCart() {
  ...
  for (var i = 0; i < window.localStorage.length; i++) {
    ...
    photocell.innerHTML =
      "<img src='" +
      item.photo +
      "' class='img-fluid rounded shadow h-100 mb-3' width='150px''/>";
    ...
    removeLink.innerHTML =
      "<button class='btn btn-danger'><i class='fa fa-trash text-light'></i></button>";
